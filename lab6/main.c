...
PRIVATE void announce(void)
{
  ...
  printf("\nMINIX %s.%s. "
	...
	"(" _SVN_REVISION ")\n"
#endif
      "WHATS GOOD YOUTUBE ITS YO BOI ACHEREKDJIAN HERE BACK AT IT AGAIN, MAKE SURE YOU HIT THAT NOTIFICATION BUTTON, COMMENT, LIKE AND SUBSCRIBE YA DWEEBS!!!\n",
      OS_RELEASE, OS_VERSION);
  printf("ESKEEEEETTTTIIIIIITTTTT YAAAAHHHHH YEEEEEEEEETTTTTT ~STRAIGHT~UP~\n");
}
